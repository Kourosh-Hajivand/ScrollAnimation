        ...
        >
            <div className=" md:w-1/2 flex items-center justify-center">
                <div className="max-w-sm w-full">
                    <div className="backdrop-blur bg-black/40 text-white rounded-2xl px-8 py-12">
                        {props.children}
                    </div>
                </div>
            </div>
        ...
        <Scroll html>
            <div className="w-screen">
                <Section opacity={opacityFirstSection}>
                    <div className="flex flex-col gap-1 items-center ">
                        <div className="w-[120px] h-[120px] relative mb-2">
                            <Image src={"/Logo-White1.png"} fill alt="logo" />
                        </div>
                ...
                <Section right opacity={opacitySecondSection}>
                    <div>
                        <h1 className="text-2xl text-white font-semibold mb-6 text-center">How to Reach Me?</h1>
                        <div className="flex items-center justify-center  gap-12">
                            <button className="px-2  rounded-2xl hover:bg-black/20 hover:scale-110 duration-150">
                                <a
                                    rel="noreferrer"
                                    aria-label="GitHub"
                                    ...
                                    target={"_blank"}
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="84" height="84" viewBox="0 0 48 48">
                ...
                <Section opacity={opacityLastSection}>
                    ...
                    <h1 className="text-2xl text-white font-semibold mb-4">Call me maybe?</h1>
                    <p className="p-3 py-6 bg-black/50 rounded-lg">
                        📞 <a href="tel:(+98) 9038953557" className="font-bold">(+98) 9038953557</a>
                    </p>
                </Section>
            </div>
        </Scroll>
